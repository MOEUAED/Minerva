...
$route->get('/teacher/classes', ['ClassController', 'index']);
...
$route->post('/teacher/works', ['WorkController', 'workCreate']);
...
$route->get('/teacher/attendance', ['AttendanceController', 'attendance']);
$route->post('/teacher/attendance', ['AttendanceController', 'attendance']);
